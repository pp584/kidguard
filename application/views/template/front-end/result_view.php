            ...
            <div class="container">
                <div class="row">
                    <div class="col-12" class="text">
                        <span class="text">Result of Behavioral Assessment of Substance Abuse </span>
                        <h5>ผลประเมินปัจจัยบริบทและพฤติกรรมเสี่ยงต่อการใช้สารเสพติด </h5>
                        <h5><a href="index.html" class="text">Home</a> - Result of Behavioral Assessment of Substance Abuse</h5>
                    </div>
                </div>
            </div>
        </section>
                                ...
                                <?php foreach ($results as $row) { ?>
                                    <article class="no-hover-shadow ms-news-detail-page">
                                        ...
                                        <div class="ms-content-area bg-white">
                                            <h4 class="font-weight-bold mt-3 ms-news-title"><?php echo $row->ca_resuscitation_name ?></h4>
                                            <p class="mb-5"><?php echo $row->ca_resuscitation_detail ?></p>
                                            <div class="ms-image-sec">
                                                <img src="{base_url}<?php echo $row->img ?>" class="img-fluid" alt="News Main Image">
                                            </div>
