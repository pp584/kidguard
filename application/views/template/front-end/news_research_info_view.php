            ...
            <div class="container">
                <div class="row">
                    <div class="col-12" class="text">
                        ...
                        <h3 class="hero-text">งานวิจัย</h3>
                        <h5><a href="index.html" class="text">Home</a> - Research</h5>
                    </div>
                </div>
            </div>
        </section>
                                ...
                                <?php foreach ($results as $row) { ?>
                                    <article class="no-hover-shadow ms-news-detail-page">
                                        ...
                                        <div class="ms-content-area bg-white">
                                            ...
                                            <span class="ms-title-15 mr-4">ผู้วิจัย</span>
                                            <p class="mb-5"><?php echo $row->research_name ?></p>
                                            <?php if ($row->files != '') { ?>
                                                <hr />
                                                <span class="ms-title-15 mr-4">ไฟล์เพิ่มเติม</span>
