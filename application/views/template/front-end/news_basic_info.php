								...
								<?php foreach ($cms_posts as $row) { ?>
									<div class="col-md-4">
										<article class="ms-news-grid-sidebar">
											<div class="ms-image-sec centered-content">
												<img style="height: 250px;" src="{base_url}<?php echo $row->images ?>" class="img-fluid" alt="News Image">
											</div>
											<div class="ms-content-area bg-white" style="border: 1px solid #d0d0d0; padding: 10px">
												<span class="ms-title-15 centered-content"><a href="#."><span class="ms-title-15"><?php echo $row->subject ?></span><br />
														<div class="centered-content">
															<a href="{site_url}news_basic_info/preview/<?php echo $row->ca_basic_info ?>" class="btn ms-secondary-btn mt-4">Read More</a>
														</div>
											</div>
										</article>
									</div>
