				...
				<div class="row">
					<div class="col-lg-7">
						...
						foreach ($cms_about_us as $row) {
							$i = $i + 1; ?>
							<h2 class="font-weight-bold mb-4"><?php echo $row->title_th; ?></h2>
							<h4 class="font-weight-bold mb-4"><?php echo $row->title_en; ?></h4>
							<h5 class="font-weight-bold mt-3 ms-news-title"> <?php echo $row->cardiac_arrest; ?></h5>
						<?php } ?>
