								...
								<?php foreach ($cms_posts as $row) { ?>
									<div class="col-md-3">
										<article class="ms-news-grid-sidebar">
											...
											<div class="ms-content-area bg-white" style="border: 1px solid #d0d0d0; padding: 10px">
												<span class="ms-title-15"><a href="#."><span class="ms-title-15"><?php echo $row->title ?></span>
														<!-- <h4 class="font-weight-bold mt-3 ms-news-title"><?php echo $row->message ?></a></h4> -->
														<div class="centered-content">
															<a href="{site_url}announcement/preview/<?php echo $row->id ?>" class="btn ms-secondary-btn mt-4">Read More</a>
														</div>
											</div>
										</article>
									</div>
