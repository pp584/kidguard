			...
			<div class="container pb-5">
				<div class="row">
					<div class="col-12" class="text" style="text-shadow: 1px 3px 8px rgba(0, 0, 0, 1);">
						<span class="text text-white">Basic info</span>
						<h3 class="hero-text text-white my-2">ข้อมูลพื้นฐาน</h3>
						<h5 class="text-white"><a href="./" class="text text-white"><u>Home</u></a> - Basic info</h5>
					</div>
				</div>
			</div>
		</section>
									...
									<article class="no-hover-shadow ms-news-detail-page">
										...
										<div class="ms-content-area bg-white">
											<div class="ms-image-sec">
												<img src="{base_url}<?php echo $row->images ?>" class="img-fluid" alt="News Main Image">
											</div>

											<span class="ms-title-15"><a href="#."><?php echo $row->create_date ?> </a></span>
											<h4 class="font-weight-bold mt-3 ms-news-title"><?php echo $row->subject ?></h4>
											<p class="mb-5"><?php echo $row->detail ?></p>
											<?php if ($row->files != '') { ?>
												<hr />
