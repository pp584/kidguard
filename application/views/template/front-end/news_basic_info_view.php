            ...
            <div class="container">
                <div class="row">
                    <div class="col-12" class="text">
                        ...
                        <h3 class="hero-text">ข้อมูลพื้นฐาน</h3>
                        <h5><a href="index.html" class="text">Home</a> - Basic info</h5>
                    </div>
                </div>
            </div>
        </section>
                                ...
                                <?php foreach ($results as $row) { ?>
                                    <article class="no-hover-shadow ms-news-detail-page">
                                        ...
                                        <div class="ms-content-area bg-white">
                                            ...
                                            <span class="ms-title-15 mr-4"><a href="#."><?php echo $row->create_date ?> </a></span>
