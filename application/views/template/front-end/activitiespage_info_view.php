			...
			<div class="container pb-5">
				<div class="row">
					<div class="col-12" class="text" style="text-shadow: 1px 3px 8px rgba(0, 0, 0, 1);">
						<span class="text text-white">Activities</span>
						<h3 class="hero-text text-white my-2">กิจกรรม</h3>
						<h5 class="text-white"><a href="./" class="text text-white"><u>Home</u></a> - Activities</h5>
					</div>
				</div>
			</div>
		</section>
