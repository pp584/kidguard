            ...
            <div class="container">
                <div class="row">
                    <div class="col-12" class="text">
                        <span class="text"> Understand" and "Present </span>
                        <h5>"เข้าใจ" และ "ให้โอกาส" </h5>
                        <h5><a href="index.html" class="text">Home</a> - Understand" and "Present </h5>
                    </div>
                </div>
            </div>
        </section>
                                ...
                                <?php foreach ($results as $row) { ?>
                                    <article class="no-hover-shadow ms-news-detail-page">
                                        ...
                                        <div class="ms-content-area bg-white">
                                            ...
                                            <h4 class="font-weight-bold mt-3 ms-news-title"><?php echo $row->ca_symptoms_name ?></h4>
                                            <p class="mb-5"><?php echo $row->ca_symptoms_detail ?></p>
