			...
			<div class="container pb-5">
				<div class="row">
					<div class="col-12" class="text" style="text-shadow: 1px 3px 8px rgba(0, 0, 0, 1);">
						<span class="text text-white">Post news</span>
						<h3 class="hero-text text-white my-2">ประชาสัมพันธ์</h3>
						<h5 class="text-white"><a href="./" class="text text-white"><u>Home</u></a> - Post news</h5>
					</div>
				</div>
			</div>
		</section>
								...
								<?php foreach ($results as $row) { ?>
									<article class="no-hover-shadow ms-news-detail-page">
										...
										<div class="ms-content-area bg-white">
											...
											<span class="ms-title-15"><a href="#."><?php echo $row->created ?> </a></span>
