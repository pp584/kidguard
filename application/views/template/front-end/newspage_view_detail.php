...
<body>
	...
	<div id="homepage-three" class="overflow-hidden">
		...
		<!-- Banner Section -->
		<section class="inner-bnr d-flex align-items-end pb-5" style="min-height: 550px;padding: unset; background: url({base_url}/assets/images/banner/3.jpg) no-repeat center; background-size: cover">
			<div class="container pb-5">
				<div class="row">
					<div class="col-12" class="text" style="text-shadow: 1px 3px 8px rgba(0, 0, 0, 1);">
						<span class="text text-white">Announcement</span>
						<h3 class="hero-text text-white my-2">ข่าวสาร</h3>
						<h5 class="text-white"><a href="./" class="text text-white"><u>Home</u></a> - Announcement</h5>
					</div>
				</div>
			</div>
		</section>
						...
						<div class="primary-content-area text-center">
							<div class="row">
								<?php foreach ($results as $row) { ?>
									<article class="no-hover-shadow ms-news-detail-page">

										<div class="ms-content-area bg-white">
											<div class="ms-image-sec">
												<img src="{base_url}<?php echo $row->image ?>" class="img-fluid" alt="News Main Image">
											</div>
											<span class="ms-title-15 mr-4"><a href="#."><?php echo $row->created ?> </a></span>
											<h4 class="font-weight-bold mt-3 ms-news-title"><?php echo $row->title ?></h4>
											<p class="mb-5"><?php echo $row->message ?></p>
											<br />
											<span>วันที่เผยแพร่ <?php echo $row->created ?> </span> <span>ยอดเข้าชม <?= $row->page_views_total ?> ครั้ง</span>
										</div>
									</article>
							...
							<div class="row">
								<div class="offset-md-1 col-md-10 text-center">
									<a href="javascript:history.back()" class="btn ms-secondary-btn"><i class="fas fa-undo mr-2"></i> ย้อนกลับ </a>
									<div class="ms-footer-seperator mt-5"></div>
								</div>
							</div>
