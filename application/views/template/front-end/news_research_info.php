									...
									<div class="col-md-4">
										<article class="ms-news-grid-sidebar">
											...
											<div class="ms-content-area bg-white" style="border: 1px solid #d0d0d0; padding: 10px">
												<span class="ms-title-15"><a href="#."><span class="ms-title-15"><?php echo $row->subject ?></span><br />
														<div class="centered-content">
															<a href="{site_url}news_research_info/preview/<?php echo $row->cms_researchs_id ?>" class="btn ms-secondary-btn mt-4">Read More</a>
														</div>
											</div>
										</article>
									</div>
