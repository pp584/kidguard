                                    ...
                                    <table class="table" style="width: 100%; table-layout: fixed;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="radio" name="quest_33" data-record-value="{record_quest_33}" value="3" id="quest_33_1-2"></td>
                                                <td><input type="radio" name="quest_33" data-record-value="{record_quest_33}" value="4" id="quest_33_1-3"></td>
                                                <td><input type="radio" name="quest_33" data-record-value="{record_quest_33}" value="5" id="quest_33_1-4"></td>
                                            </tr>
                                            <tr>
                                                <td>4</td>
