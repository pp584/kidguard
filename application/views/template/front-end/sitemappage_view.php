            ...
            <div class="container">
                <div class="row">
                    <div class="col-12" class="text">
                        ...
                        <h3 class="hero-text">แผนผังเว็บไซต์</h3>
                        <h5><a href="{base_url}/home" class="text">Home</a> - Sitemap</h5>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-12 col-md-12 col-sm-12">
                        ...
                        <div class="card card-body ">
                            <div class="col-6">
                                ...
                                <span><b>เกี่ยวกับเรา</b></span>
                                <ul>
                                    <li><a href="{base_url}/about">เกี่ยวกับเรา</a></li>
                                </ul>
                                <hr />
                                <span><b>ข่าวสาร</b></span>
                                <ul>
                                    <li><a href="{base_url}/announcement">ข่าวสาร</a></li>
                                    <li><a href="{base_url}/postnews">ประชาสัมพันธ์</a></li>
                                    <li><a href="{base_url}/activities">กิจกรรม</a></li>
                                </ul>
                                <hr />
                            </div>

                            <div class="col-6">
                                <span><b>คำถามพบบ่อย</b></span>
                                <ul>
                                    <li><a href="{base_url}/faq">คำถามพบบ่อย</a></li>
                                </ul>
                                <hr />

                                <span><b>ติดต่อเรา</b></span>
                                <ul>
                                    <li><a href="{base_url}/contactus">ติดต่อเรา</a></li>
                                </ul>
                                <hr />
                                <span><b>แบบประเมิน</b></span>
                                <ul>
                                    <li><a href="{base_url}/assessment/assessment_create">แบบประเมิน</a></li>
                                </ul>
                                <hr />
                            </div>
