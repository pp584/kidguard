...
<body>
	...
	<div id="homepage-three" class="overflow-hidden">
			...
			<div class="container pb-5">
				<div class="row">
					<div class="col-12" class="text" style="text-shadow: 1px 3px 8px rgba(0, 0, 0, 1);">
						<span class="text text-white">FAQ</span>
						<h3 class="hero-text text-white my-2">คำถามพบบ่อย</h3>
						<h5 class="text-white"><a href="./" class="text text-white"><u>Home</u></a> - FAQ</h5>
					</div>
				</div>
			</div>
		</section>
		...
		<!-- Blogs Section -->
		<section id="ms-faq-sec" class="pad-100">
			<div class="container">
				<div class="row">
					<div class="offset-md-3 col-md-6 text-center">
						<h2 class="font-weight-bold">คำถามที่พบบ่อย</h2>
						<h5>Find the answers to our frequently asked questions here.</h5>
				...
				<div class="row">
					...
					<?php foreach ($cms_faq as $row) { ?>
						<div class="col-md-6">
							<div class="accordion" id="accordionOne">
								<div class="card">
									<div class="card-header" id="headingTwo">
										<h2 class="mb-0 card-title">
											<button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#<?php echo $row->cms_faq_id; ?>" aria-expanded="false" aria-controls="collapseTwo">
												<?php echo $row->cms_faq_title; ?>
											</button>
										</h2>
									</div>
									<div id="<?php echo $row->cms_faq_id; ?>" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionOne">
										<div class="card-body">
											<p class="mb-0"> <?php echo $row->faq_detail; ?></p>
										</div>
									</div>
								</div>
							</div>
