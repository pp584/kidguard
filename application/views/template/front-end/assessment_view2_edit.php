                                                ...
                                                <table class="table" style="width: 100%; table-layout: fixed;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="radio" name="quest_32" data-record-value="{record_quest_32}" value="1" id="quest_32-1"></td>
                                                            <td><input type="radio" name="quest_32" data-record-value="{record_quest_32}" value="2" id="quest_32-2"></td>
                                                            <td><input type="radio" name="quest_32" data-record-value="{record_quest_32}" value="3" id="quest_32-3"></td>
                                                            <td><input type="radio" name="quest_32" data-record-value="{record_quest_32}" value="4" id="quest_32-4"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>33</td>
                                                            <td>ฉันรู้สึกรำคาญ เมื่อเพื่อนยืมใช้ของส่วนตัว </td>
                                                            <td><input type="radio" name="quest_33" data-record-value="{record_quest_33}" value="1" id="quest_33-1"></td>
                                                            <td><input type="radio" name="quest_33" data-record-value="{record_quest_33}" value="2" id="quest_33-2"></td>
                                                            <td><input type="radio" name="quest_33" data-record-value="{record_quest_33}" value="3" id="quest_33-3"></td>
                                                            <td><input type="radio" name="quest_33" data-record-value="{record_quest_33}" value="4" id="quest_33-4"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>34</td>
