...
<body>
			...
			<div class="container">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="row">
							<div class="col-md-12">
								<h3 class="font-weight-bold">ตอนที่ 1 ข้อมูลพื้นฐาน</h3>
							</div>
						</div>
						<hr />
									...
									<div class="card-body">
										...
										<div class="row">
											<div class="col-lg-12 col-sm-12">
												...
												<div class="col-md-12">
													<h5 class="font-weight-bold">2. อายุ(ปี) <span style="color:red;">*</span> </h5>
												</div>


												<div class="col-md-6">
													<div class="form-group">
														<input type="text" id="question_2" value="{record_question_2}" name="question_2" required="" fdprocessedid="m15qll" placeholder="กรุณากรอก">
													</div>
												</div>
												...
												<div class="col-md-12">
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-check">
																<input class="form-check-input" type="radio" name="question_3" data-record-value="{record_question_3}" value="1" id="question_3" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">1. ศึกษาอยู่ </label>
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-check">
																<input class="form-check-input" type="radio" name="question_3" data-record-value="{record_question_3}" value="2" id="question_3" style="width:auto;">
												...
												<div class="col-md-6">
													<div class="form-group">
														<input type="text" id="question_4" name="question_4" value="{record_question_4}" required="" fdprocessedid="m15qll" placeholder="กรุณากรอก 1-6">
													</div>
												</div>
												...
												<div class="col-md-12">
													...
													<div class="row">
														...
														<div class="col-md-6">
															...
															<input type="text" maxlength="2" id="question_6" name="question_6" value="{record_question_6}" required="" fdprocessedid="m15qll" placeholder="กรุณากรอก">
														</div>
													</div>
												...
												<div class="col-md-12">
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-check">
																<input class="form-check-input" type="radio" name="question_8" data-record-value="{record_question_8}" value="1" id="question_8" style="width:auto;">
															...
															<div class="form-check">
																<input class="form-check-input" type="radio" name="question_8" data-record-value="{record_question_8}" value="3" id="question_8" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">3. พนักงานเอกชน </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="radio" name="question_8" data-record-value="{record_question_8}" value="4" id="question_8" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">4. รัฐวิสาหกิจ </label>
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-check">
																<input class="form-check-input" type="radio" name="question_8" data-record-value="{record_question_8}" value="5" id="question_8" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">5. รับจ้างทั่วไป </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="radio" name="question_8" data-record-value="{record_question_8}" value="6" id="question_8" style="width:auto;">
															...
															<div class="form-check">
																<input class="form-check-input" type="radio" name="question_8" data-record-value="{record_question_8}" value="7" id="question_8" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">7. อื่น ๆ</label>
															</div>
															<input type="text" id="question_9" name="question_9" value="{record_question_9}" fdprocessedid="m15qll" placeholder="กรุณากรอก ">
														</div>
													</div>
												...
												<div class="col-md-12">
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-check">
																<input class="form-check-input" type="radio" name="question_10" data-record-value="{record_question_10}" value="1" id="question_10" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">1. เกษตร (ทำไร่,ทำนา,ทำสวน,ประมง,ปศุสัตว์) </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="radio" name="question_10" data-record-value="{record_question_10}" value="2" id="question_10" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault2" style="position:relative;color:black;top:-3px;">2. รับราชการ / พนักงานราชการ </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="radio" name="question_10" data-record-value="{record_question_10}" value="3" id="question_10" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">3. พนักงานเอกชน </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="radio" name="question_10" data-record-value="{record_question_10}" value="4" id="question_10" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">4. รัฐวิสาหกิจ </label>
															</div>
														</div>
														<div class="col-md-6">
															...
															<div class="form-check">
																<input class="form-check-input" type="radio" name="question_10" data-record-value="{record_question_10}" value="5" id="question_10" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">6. ธุรกิจส่วนตัว/อิสระ </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="radio" name="question_10" data-record-value="{record_question_10}" value="6" id="question_10" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">7. อื่น ๆ </label>
															</div>
															<input type="text" id="question_11" name="question_11" value="{record_question_11}" fdprocessedid="m15qll" placeholder="กรุณากรอก ">
														</div>
													</div>
												...
												<div class="col-md-12">
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-check">
																<input class="form-check-input" type="radio" data-record-value="{record_question_15}" name="question_15" value="1" id="question_15" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">1. เคย </label>
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-check">
																<input class="form-check-input" type="radio" data-record-value="{record_question_15}" name="question_15" value="2" id="question_15" style="width:auto;">
												...
												<div class="col-md-12">
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-check">
																<input class="form-check-input" type="checkbox" data-record-value="{record_question_16}" name="question_16[]" value="1" id="question_16_1" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">1. ยาบ้า </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="checkbox" data-record-value="{record_question_16}" name="question_16[]" value="2" id="question_16_2" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">2. ยาอี </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="checkbox" data-record-value="{record_question_16}" name="question_16[]" value="3" id="question_16_3" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">3. ยาเค </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="checkbox" data-record-value="{record_question_16}" name="question_16[]" value="4" id="question_16_4" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">4. ฝิ่น </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="checkbox" data-record-value="{record_question_16}" name="question_16[]" value="5" id="question_16_5" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">5. เฮโรอีน </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="checkbox" data-record-value="{record_question_16}" name="question_16[]" value="6" id="question_16_6" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">6. กัญชา </label>
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-check">
																<input class="form-check-input" type="checkbox" data-record-value="{record_question_16}" name="question_16[]" value="7" id="question_16_7" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault2" style="position:relative;color:black;top:-3px;">7. ใบกระท่อม </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="checkbox" data-record-value="{record_question_16}" name="question_16[]" value="8" id="question_16_8" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">8. ทินเนอร์/กาว </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="checkbox" data-record-value="{record_question_16}" name="question_16[]" value="9" id="question_16_9" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">9. ยาไอซ์ </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="checkbox" data-record-value="{record_question_16}" name="question_16[]" value="10" id="question_16_10" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">10. บุหรี่ </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="checkbox" data-record-value="{record_question_16}" name="question_16[]" value="11" id="question_16_11" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">11. สุรา </label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="checkbox" data-record-value="{record_question_16}" name="question_16[]" value="12" id="question_16_12" style="width:auto;">
																<label class="form-check-label" for="flexRadioDefault1" style="position:relative;color:black;top:-3px;">12. อื่น ๆ โปรดระบุ </label>
															</div>
															<input type="text" id="question_17" name="question_17" value="{record_question_17}" required="" fdprocessedid="m15qll" placeholder="กรุณากรอก ">
														</div>
														<br />
														<div class="col-md-12">
															<br /><br />
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			/*
			$('input[type=radio][name="question_15"]').on('change', function() {
			    // alert(this.value);
			    var data = this.value;
			    if(data == 1){
			        $( "#question_16_1" ).prop( "disabled", false );
			        $( "#question_16_2" ).prop( "disabled", false );
			        $( "#question_16_3" ).prop( "disabled", false );
			        $( "#question_16_4" ).prop( "disabled", false );
			        $( "#question_16_5" ).prop( "disabled", false );
			        $( "#question_16_6" ).prop( "disabled", false );
			        $( "#question_16_7" ).prop( "disabled", false );
			        $( "#question_16_8" ).prop( "disabled", false );
			        $( "#question_16_9" ).prop( "disabled", false );
			        $( "#question_16_10" ).prop( "disabled", false );
			        $( "#question_16_11" ).prop( "disabled", false );
			        $( "#question_16_12" ).prop( "disabled", false );

			        $( "#question_17" ).prop( "disabled", false );
			    }else{
			        $( "#question_16_1" ).prop( "disabled", true );
			        $( "#question_16_2" ).prop( "disabled", true );
			        $( "#question_16_3" ).prop( "disabled", true );
			        $( "#question_16_4" ).prop( "disabled", true );
			        $( "#question_16_5" ).prop( "disabled", true );
			        $( "#question_16_6" ).prop( "disabled", true );
			        $( "#question_16_7" ).prop( "disabled", true );
			        $( "#question_16_8" ).prop( "disabled", true );
			        $( "#question_16_9" ).prop( "disabled", true );
			        $( "#question_16_10" ).prop( "disabled", true );
			        $( "#question_16_11" ).prop( "disabled", true );
			        $( "#question_16_12" ).prop( "disabled", true );
			        $( "#question_17" ).prop( "disabled", true );
			    }
			});
			*/
			...
			$('input[type=radio][name="question_10"]').on('change', function() {
				// alert(this.value);
				var data = this.value;
				if (data == 6) {
					$("#question_11").prop("disabled", false);
				} else {
					$("#question_11").prop("disabled", true);
				}

			});


			$('input[type=radio][name="question_8"]').on('change', function() {
				// alert(this.value);
				var data = this.value;
				if (data == 7) {
					$("#question_9").prop("disabled", false);
				} else {
					$("#question_9").prop("disabled", true);
				}
			});



			$('input[type=radio][name="question_3"]').on('change', function() {
				// alert(this.value);
				var data = this.value;
				if (data == 1) {
					$("#question_4").prop("disabled", false);
				} else {
					$("#question_4").prop("disabled", true);
				}
			});


			$('input[type=radio][name="question_5"]').on('change', function() {
				// alert(this.value);
				var data = this.value;
				if (data == 2) {
					$("#question_6").prop("disabled", false);
				} else {
					$("#question_6").prop("disabled", true);
				}
			...
			$('#question_2').inputmask("numeric", {
				"placeholder": "ระบุ 1-5 ปี ",
				min: 13,
				max: 15,
			...
			$("#question_6").inputmask("numeric", {
				min: 0,
				max: 20
			});


			$("#question_4").inputmask("numeric", {
				min: 1,
				max: 15
			});
