 ...
 */
class Postnews extends CRUD_Controller
{
	private $per_page;
	private $another_js;
	private $another_css;
	...
	private function render_view($path)
	{
		...
		$this->parser->parse('template/front-end/postnewspage_view', $this->data);
	}


	public function cms_posts()
	{
		$cms_about_us = $this->modeldb->get_list("cms_posts", "category_id=2 and status='published'");
		return $cms_about_us;
	}
	...
	public function preview($encrypt_id = "")
	{
		...
		if ($id == "") {
			...
			$this->parser->parse('template/front-end/postnewspage_view_detail', $this->data);
		}
	}
