 ...
 */
class Asked_questions extends CRUD_Controller
{
	private $per_page;
	private $another_js;
	private $another_css;
	...
	private function render_view($path)
	{
		...
		$this->data['cms_faq']	=  $this->cms_posts();
		$this->parser->parse('template/front-end/faqpage_view', $this->data);
	...
	{
		$cms_about_us = $this->modeldb->get_list("cms_faq");
		return $cms_about_us;
	}
