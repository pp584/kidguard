...
class Activities extends CRUD_Controller
{
	...
	private function render_view($path)
	{
		...
		$this->parser->parse('template/front-end/activitiespage_view', $this->data);
	}
	...
	public function preview($encrypt_id = "")
	{
		...
		if ($id == "") {
			...
			$this->parser->parse('template/front-end/activitiespage_info_view', $this->data);
		}
	}
	...
	{
		$cms_about_us = $this->modeldb->get_list("cms_posts", "category_id=3 and status = 'published'");
		return $cms_about_us;
	}
