...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-newspaper"></i> จัดการข่าวสาร/กิจกรรม/ข่าวประชาสัมพันธ์</h3>
	</div>
	<div class="card-body">
		<div class="row">
			<div class="col-sm-12 col-md-12 mb-3">
				<div class="text-right">
					<a href="{page_url}/add" class="btn btn-success" data-toggle="tooltip" title="เพิ่มข้อมูลใหม่">
						<i class="fa fa-plus-square"></i></span> เพิ่ม ข่าวสาร/ประชาสัมพันธ์/กิจกรรม ใหม่
					</a>
				</div>
			</div>
