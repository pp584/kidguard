...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> จัดการข้อมูลทีมงานวิจัย</h3>
	</div>
	<div class="card-body">
		<div class="row">
			<div class="col-sm-12 col-md-12 mb-3">
				<div class="text-right">
					<a href="{page_url}/add" class="btn btn-success btn-lg" data-toggle="tooltip" title="เพิ่มข้อมูลใหม่">
						<i class="fa fa-plus-square"></i></span> เพิ่มรายชื่อนักวิจัยใหม่
					</a>
				</div>
			</div>
				...
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<div class="form-group">
						<select class="form-control" name="search_field" class="span2">
							<option value="cms_team_id">เลือก</option>
				...
				<div class="pull-right text-right">
					<div class="form-group">
						<select class="form-control" id="set_order_by" class="span2" value="{order_by}">
							...
							<option value="cms_team_id|asc">cms_team_id น้อย - มาก</option>
							<option value="cms_team_id|desc">cms_team_id มาก - น้อย</option>
			...
			<table class="table table-bordered table-striped table-hover">
				...
				<tbody>
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td><img style="height: 75px; width: 75px;" src="{base_url}{photo}"></td>
						<td>{name}</td>
						<td>{company_name}</td>
						<td>{tel}</td>
						<td>{level}</td>
						<td>
							<div class="btn-group pull-right">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm" data-toggle="tooltip" title="ลบรายการนี้" data-cms_team_id="{encrypt_cms_team_id}" data-row-number="{record_number}">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="formDelete">
					...
					<input type="hidden" name="encrypt_cms_team_id" />
