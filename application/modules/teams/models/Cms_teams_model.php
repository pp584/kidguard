...
/**
 * Cms_teams_model Class
 * @date 2022-04-24
 */
class Cms_teams_model extends MY_Model
{
	...
	{
		$cms_team_id = checkEncryptData($data['cms_team_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.cms_team_id = $cms_team_id");
	...
	{
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.cms_team_id = $id");
	...
	*/
	...
	public function update($post)
	{
		...
		if(!empty($data)){
			$cms_team_id = checkEncryptData($post['encrypt_cms_team_id']);
			$this->set_table_name($this->my_table);
			$this->set_where("$this->my_table.cms_team_id = $cms_team_id");
