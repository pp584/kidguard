...
class Slides_model extends MY_Model
{
	...
	{
		$cms_slide_id = checkEncryptData($data['cms_slide_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.cms_slide_id = $cms_slide_id");
	...
	{
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.cms_slide_id = $id");
	...
	*/
	...
	public function update($post)
	{
		...
		if(!empty($data)){
			$cms_slide_id = checkEncryptData($post['encrypt_cms_slide_id']);
			$this->set_table_name($this->my_table);
			$this->set_where("$this->my_table.cms_slide_id = $cms_slide_id");
