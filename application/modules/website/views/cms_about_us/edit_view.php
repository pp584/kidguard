...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-edit"></i> แก้ไขข้อมูลเกี่ยวกับเรา<strong></strong></h3>
	</div>
	<div class="card-body">
		<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
			...
			<div class='form-group'>
				<label class='col-sm-2 control-label' for='title_th'>เกี่ยวกับเรา TH :</label>
				<div class='col-sm-10'>

					<input type="text" class="form-control " id="title_th" name="title_th" value="{record_title_th}" />
				</div>
			</div>
			<div class='form-group'>
				<label class='col-sm-2 control-label' for='title_en'>เกี่ยวกับเรา EN :</label>
				<div class='col-sm-10'>

					<input type="text" class="form-control " id="title_en" name="title_en" value="{record_title_en}" />
				</div>
			</div>
			<div class='form-group'>
				<label class='col-sm-2 control-label' for='detail'>รายละเอียดเกี่ยวกับเรา :</label>
				<div class='col-sm-10'>
			...
			<div class='form-group'>
				<label class='col-sm-2 control-label' for='cardiac_arrest'>รายละเอียด:</label>
				<div class='col-sm-10'>

					<textarea class="form-control" id="cardiac_arrest" name="cardiac_arrest" rows="5">{record_cardiac_arrest}</textarea>
				</div>
			</div>
			<div class='form-group'>
