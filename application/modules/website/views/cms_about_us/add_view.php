<!-- [ View File name : add_view.php ] -->
	<div class="card">
		<div class="card-header bg-primary">
			<h3 class="card-title"><i class="fa fa-plus-square"></i> เพิ่มข้อมูล <strong>Cms_about_us</strong></h3>
		</div>
		<div class="card-body">
			<form class="form-horizontal" id="formAdd" accept-charset="utf-8">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="title_th">title_th  :</label>
					<div class="col-sm-10">

						<input type="text" class="form-control " id="title_th" name="title_th" value=""  />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label" for="title_en">title_en  :</label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="cardiac_arrest">cardiac_arrest  :</label>
					<div class="col-sm-10">

						<textarea  class="form-control" id="cardiac_arrest" name="cardiac_arrest" rows="5"></textarea>
					</div>
				</div>
				<div class="form-group">
