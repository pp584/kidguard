...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> จัดการข้อมูลติดต่อเรา</h3>
	</div>
	<div class="card-body">
		<div class="row">
				...
				<!-- <form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<div class="form-group">
						<select class="form-control" name="search_field" class="span2">
							<option value="cms_contact_us_id">cms_contact_us_id</option>
						</select>
					</div>
					<div class="form-group">
				...
				<div class="pull-right text-right">
					<div class="form-group">
						<!-- <select class="form-control" id="set_order_by" class="span2" value="{order_by}">
							...
							<option value="cms_contact_us_id|asc">cms_contact_us_id น้อย - มาก</option>
							<option value="cms_contact_us_id|desc">cms_contact_us_id มาก - น้อย</option>
						</select> -->
					</div>
				</div>
			</div>
					...
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td class="text-center">
							<div class="btn-group ">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm" data-toggle="tooltip" title="ลบรายการนี้" data-cms_contact_us_id="{encrypt_cms_contact_us_id}" data-row-number="{record_number}">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="formDelete">
					...
					<input type="hidden" name="encrypt_cms_contact_us_id" />
