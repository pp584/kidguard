...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-plus-square"></i> เพิ่มข้อมูล <strong>Slider</strong></h3>
	</div>
	<div class="card-body">
		<form class="form-horizontal" id="formAdd" accept-charset="utf-8">
			{csrf_protection_field}
			<div class="form-group">
				<label class="col-sm-2 control-label" for="title">เรื่อง <span style="color:red;"> * </span> :</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<input type="number" maxlength="1" class="form-control " id="sequences" name="sequences" value="" />
