...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> จัดการข้อมูลพื้นฐาน </h3>
	</div>
	<div class="card-body">
		<div class="row">
			<div class="col-sm-12 col-md-12 mb-3">
				<div class="text-right">
					<a href="{page_url}/add" class="btn btn-success btn-lg" data-toggle="tooltip" title="เพิ่มข้อมูลใหม่">
						<i class="fa fa-plus-square"></i></span> เพิ่มข้อมูลพื้นฐานใหม่ 
					</a>
		</div>
		</div>
			<div class="col-sm-12 col-md-9">
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<option value="ca_basic_info">ca_basic_info</option>
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="ca_basic_info|asc">ca_basic_info น้อย - มาก</option><option value="ca_basic_info|desc">ca_basic_info มาก - น้อย</option><option value="subject|asc">เรื่อง ก - ฮ</option><option value="subject|desc">เรื่อง ฮ - ก</option>
						</select>
 					</div>
				</div>
			</div>
							...
							<div class="btn-group ">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-ca_basic_info = "{encrypt_ca_basic_info}" data-row-number="{record_number}">
...
<label class="col-sm-3 text-right badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
					...
					<input type="hidden" name="encrypt_ca_basic_info" />
