...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> จัดการข่าวสาร/กิจกรรม/ข่าวประชาสัมพันธ์</h3>
	</div>
	<div class="card-body">
		<div class="row">
			<div class="col-sm-12 col-md-12 mb-3">
				<div class="text-right">
					<a href="{page_url}/add" class="btn btn-success btn-lg" data-toggle="tooltip" title="เพิ่มข้อมูลใหม่">
						<i class="fa fa-plus-square"></i></span> เพิ่มข่าวสาร/กิจกรรม/ข่าวประชาสัมพันธ์ใหม่
					</a>
		</div>
		</div>
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="id|asc">ID น้อย - มาก</option><option value="id|desc">ID มาก - น้อย</option><option value="title|asc">เรื่อง ก - ฮ</option><option value="title|desc">เรื่อง ฮ - ก</option>
						</select>
 					</div>
				</div>
			</div>
