<!--  [ View File name : edit_view.php ] -->
	<div class="card">
		<div class="card-header bg-primary">
			<h3 class="card-title"><i class="fa fa-edit"></i> แก้ไขข้อมูลงานวิจัย</h3>
		</div>
		<div class="card-body">
			<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
				...
				<div class='form-group'>
					...
					<div class='col-sm-10'>
						...
						<input type="text" class="form-control " id="research_name" name="research_name" value="{record_research_name}"  />
					</div>
				</div>
				<div class='form-group'>
