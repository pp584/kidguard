...
class Profile extends CRUD_Controller
{
	...
	public function edit($encrypt_id = '')
	{
		...
		if ($id == "") {
			...
			if (empty($results)) {
				...
				$this->data['tb_members_prefix_prefix_option_list'] = $this->Profile->returnOptionList("tb_members_prefix", "prefix_name", "prefix_name");
	...
	private function setPreviewFormat($lists_data)
	{
		...
		$prefixDpmName = $this->Profile->getValueOf('tb_department', 'dpm_name', "dpm_id = $data[prefix]");
		$this->data['prefixDpmName'] = $prefixDpmName;
