...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> จัดการ log การใช้งาน</h3>
	</div>
	<div class="card-body">
		<div class="row">
				...
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<div class="form-group">
						<select class="form-control" name="search_field" class="span2">
							<option value="log_id">log_id</option>
						</select>
					</div>
					<div class="form-group">
				...
				<div class="pull-right text-right">
					<div class="form-group">
						<select class="form-control" id="set_order_by" class="span2" value="{order_by}">
							...
							<option value="log_id|asc">log_id น้อย - มาก</option>
							<option value="log_id|desc">log_id มาก - น้อย</option>
						</select>
					</div>
				</div>
			</div>
			...
			<table class="table table-bordered table-striped table-hover">
				<thead class="info">
					<tr bgcolor="#dddddd">
						...
						<th>ชื่อผู้ใช้งาน</th>
						<th>เมื่อไหร่</th>
						<th>หมายเหตุ (ต้องระบุ)</th>
						<th>ที่ตารางไหน</th>
						<th>PK ฟิลด์</th>
						<th>PK ข้อมูล</th>
						<th>เก็บเงื่อนไขการอัพเดต</th>
						<!--<th>อ้างอิงการ ตาราง Login</th>-->
				...
				<tbody>
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td>{log_edit_table}</td>
						<td>{log_edit_table_pk_name}</td>
						<td>{log_edit_table_pk_value}</td>
						...
						<!-- <td>
                            <div class="btn-group pull-right">
                                ...
                                <a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm" data-toggle="tooltip" title="ลบรายการนี้" data-log_id="{encrypt_log_id}" data-row-number="{record_number}">
