...
/**
 * Verify_information_model Class
 * @date 2022-05-09
 */
class Verify_information_model extends MY_Model
{
	...
	public function create($post)
	{
		...
		$data = array(
				'master_ohca_id' => $post['master_ohca_id']
	...
	*/
	public function read($start_row = FALSE, $per_page = FALSE)
	{
		...
		if ($where != '') {
			$this->db->join('service_information AS service_information_1', "$this->my_table.service_unit_name = service_information_1.service_unit_name", 'left');
		...
		$this->db->select("$this->my_table.*, service_information_1.service_unit_name AS serviceUnitNameServiceUnitName
