...
class Patient_profile_model extends MY_Model
{
	...
	*/
	public function read($start_row = FALSE, $per_page = FALSE)
	{
		...
		$where	.= "service_information_id= $id "; 
	...
	public function update($post)
	{
		$data = array(
				...
				,'age' => $post['age']
				,'sex' => $post['sex']
				// ,'right_medical' => isset($post['right_medical'])
				// ,'right_medical_remark' => isset($post['right_medical_remark'])
				,'congenital_disease' => isset($post['congenital_disease'])
				,'congenital_disease_patient' => isset($post['congenital_disease_patient'])
				,'congenital_disease_patient_remark' => isset($post['congenital_disease_patient_remark'])
		);
