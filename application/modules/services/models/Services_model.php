...
class Services_model extends MY_Model
{
	...
	{
		$services_id = checkEncryptData($data['services_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.services_id = $services_id");
	...
	{
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.services_id = $id");
	...
	*/
	...
	public function update($post)
	{
		...
		if(!empty($data)){
			$services_id = checkEncryptData($post['encrypt_services_id']);
			$this->set_table_name($this->my_table);
			$this->set_where("$this->my_table.services_id = $services_id");
