...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>service_information</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="service_information_id|asc">ID น้อย - มาก</option><option value="service_information_id|desc">ID มาก - น้อย</option>
						</select>
 					</div>
				</div>
			</div>
			...
			<table class="table table-bordered table-striped table-hover">
				<thead class="info">
					<tr bgcolor="#dddddd">
						...
						<th>เหตุการณ์ (รหัสความรุนแรง ณ จุดเกิดเหตุ: RC)</th>
						<th>สร้างโดย</th>
						<th>สถานะ</th>
							...
							<div class="btn-group pull-right">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-service_information_id = "{encrypt_service_information_id}" data-row-number="{record_number}">
