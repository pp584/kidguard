...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>basic_resuscitation</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="col-sm-12 col-md-9">
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<option value="basic_resuscitation_id">basic_resuscitation_id</option>
						</select>
 					</div>
					<div class="form-group">
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="basic_resuscitation_id|asc">basic_resuscitation_id น้อย - มาก</option><option value="basic_resuscitation_id|desc">basic_resuscitation_id มาก - น้อย</option>
						</select>
 					</div>
				</div>
			</div>
		...
		<div class="table-responsive">
			...
			<table class="table table-bordered table-striped table-hover">
				<thead class="info">
					<tr bgcolor="#dddddd">
						<th width="20px;">#</th>
						<th>การทำกู้ชีพเบื้องต้น ก่อนทีมปฏิบัติการแพทย์ฉุกเฉินมาถึง</th>
						<th>ลักษณะของการทำกู้ชีพเบื้องต้น</th>
						<th>ผู้ทำการกู้ชีพ (CPR) เบื้องต้น</th>
						<th>ประชาชนทั่วไป</th>
						<th>บุคลากรทางการแพทย์</th>
						<th>อื่นๆ</th>
						<th>มี AED ในที่สาธารณะ</th>
						<th>มีการใช้ AED โดยผู้พบเห็นเหตุการณ์ ณ จุดเกิดเหตุ</th>
						<th>ผู้ที่ใช้ AED คนแรก ณ จุดเกิดเหตุ</th>
						<th>ประชาชนทั่วไป</th>
						<th>บุคลากรทางการแพทย์</th>
							...
							<div class="btn-group pull-right">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-basic_resuscitation_id = "{encrypt_basic_resuscitation_id}" data-row-number="{record_number}">
...
<label class="col-sm-3 text-right badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
					...
					<input type="hidden" name="encrypt_basic_resuscitation_id" />
