...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>result_data</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="col-sm-12 col-md-9">
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<option value="result_data_id">result_data_id</option>
						</select>
 					</div>
					<div class="form-group">
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="result_data_id|asc">result_data_id น้อย - มาก</option><option value="result_data_id|desc">result_data_id มาก - น้อย</option>
						</select>
 					</div>
				</div>
			</div>
		...
		<div class="table-responsive">
			...
			<table class="table table-bordered table-striped table-hover">
				<thead class="info">
					<tr bgcolor="#dddddd">
						<th width="20px;">#</th>
						<th>สถานภาพผู้ป่วยภายหลังทำการช่วยชีวิต</th>
						<th>เสียชีวิต</th>
						<th>แผนกที่ผู้ป่วยเข้ารับการรักษา</th>
						<th>การรอดชีวิต จำหน่ายออกจากโรงพยาบาล</th>
						<th>จำนวนวันที่รับไว้รักษาในโรงพยาบาล</th>
						<th>วันเวลาที่จำหน่าย</th>
						<th>เหตุผลในการจำหน่าย</th>
							...
							<div class="btn-group pull-right">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-result_data_id = "{encrypt_result_data_id}" data-row-number="{record_number}">
...
<label class="col-sm-3 text-right badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
					...
					<input type="hidden" name="encrypt_result_data_id" />
