...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>treatment_information</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="col-sm-12 col-md-9">
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<option value="treatment_information_id">treatment_information_id</option>
						</select>
 					</div>
					<div class="form-group">
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="treatment_information_id|asc">treatment_information_id น้อย - มาก</option><option value="treatment_information_id|desc">treatment_information_id มาก - น้อย</option>
						</select>
 					</div>
				</div>
			</div>
		...
		<div class="table-responsive">
			...
			<table class="table table-bordered table-striped table-hover">
				<thead class="info">
					<tr bgcolor="#dddddd">
						<th width="20px;">#</th>
						<th>การบันทึกเวลา ROSC (การกลับมามีสัญญาณชีพ) ครั้งแรกเมื่อทีมปฏิบัติการแพทย์ฉุกเฉินไปถึง</th>
						<th>การทำ CPR ของทีมปฏิบัติการแพทย์ฉุกเฉิน</th>
						<th>เวลาที่เริ่ม CPR ณ จุดเกิดเหตุ</th>
						<th>เวลาที่สิ้นสุดการ CPR ณ จุดเกิดเหตุ</th>
						<th>การมี ROSC (การกลับมามีสัญญาณชีพ)</th>
						<th>มี</th>
						<th>การทำ CPR เพื่อให้ผู้ป่วยมีภาวะ ROSC คงที่</th>
						<th>การใช้ Defibrillator</th>
						<th>การประเมิน EKG หลังทำ CPR</th>
						<th>จำนวนครั้งการกระตุกหัวใจที่ได้รับ</th>
						<th>การเปิดทางเดินหายใจ</th>
						<th>การจัดการทางเดินหายใจและการช่วยหายใจ (เลือกได้มากกว่า 1 ข้อ)</th>
						<th>Non-definite airway</th>
						<th>Definite airway</th>
						<th>การ Stop bleeding (การห้ามเลือด)</th>
						<th>การให้สารน้ำทางหลอดเลือดดำ</th>
						<th>ให้</th>
						<th>อื่นๆ ระบุ</th>
						<th>การให้ยา</th>
						<th>ให้</th>
						<th>อื่นๆ ระบุ</th>
						<th>การ Hypothermia/Keep warm (ลดอุณหภูมิกาย/ห่มผ้า) ณ จุดเกิดเหตุ</th>
						<th>การ Hypothermia/Keep warm (ลดอุณหภูมิกาย/ห่มผ้า) อย่างต่อเนื่องจนถึงโรงพยาบาล</th>
						<th>เครื่อง Auto CPR</th>
						<th>มีเครื่อง Auto CPR</th>
						<th>สาเหตุการหยุด Resuscitation</th>
						<th>ผลลัพธ์การ CPR</th>
				...
				<tbody>
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td>{intravenous_fluid_remark}</td>
						<td>{preview_drug}</td>
							...
							<div class="btn-group pull-right">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-treatment_information_id = "{encrypt_treatment_information_id}" data-row-number="{record_number}">
...
<label class="col-sm-3 text-right badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
					...
					<input type="hidden" name="encrypt_treatment_information_id" />
