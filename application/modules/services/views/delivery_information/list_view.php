...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>delivery_information</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="delivery_information_id|asc">delivery_information_id น้อย - มาก</option><option value="delivery_information_id|desc">delivery_information_id มาก - น้อย</option>
						</select>
 					</div>
				</div>
			</div>
		...
		<div class="table-responsive">
			...
			<table class="table table-bordered table-striped table-hover">
				<thead class="info">
					<tr bgcolor="#dddddd">
						<th width="20px;">#</th>
						<th>โรงพยาบาลที่นำส่ง</th>
						<th>เหตุผลในการเลือกโรงพยาบาล (เลือกได้มากกว่า 1 ข้อ)</th>
						<th>ระดับการคัดกรอง</th>
						<th>การ Resuscitation  ณ แผนกอุบัติเหตุและฉุกเฉิน</th>
						<th>ระบบทางเดินหายใจ</th>
						<th>respiratory_system_remark</th>
						<th>การให้สารน้ำ</th>
						<th>water_supply_remark</th>
						<th>การห้ามเลือด</th>
						<th>hemostasis_remark</th>
						<th>การดามกระดูก</th>
						<th>splint_remark</th>
				...
				<tbody>
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td>{respiratory_system_remark}</td>
						<td>{preview_water_supply}</td>
						<td>{water_supply_remark}</td>
						<td>{preview_hemostasis}</td>
						<td>{hemostasis_remark}</td>
