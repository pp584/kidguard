...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>services</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="col-sm-12 col-md-9">
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<option value="services_name">ศูนย์บริการ</option>
						</select>
 					</div>
					<div class="form-group">
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="services_name|asc">ศูนย์บริการ ก - ฮ</option><option value="services_name|desc">ศูนย์บริการ ฮ - ก</option>
						</select>
 					</div>
				</div>
			</div>
							...
							<div class="btn-group pull-right">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-services_id = "{encrypt_services_id}" data-row-number="{record_number}">
...
<label class="col-sm-3 text-right badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
					...
					<input type="hidden" name="encrypt_services_id" />
