...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>event_information</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="col-sm-12 col-md-9">
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<option value="event_information_id">event_information_id</option>
						</select>
 					</div>
					<div class="form-group">
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="event_information_id|asc">event_information_id น้อย - มาก</option><option value="event_information_id|desc">event_information_id มาก - น้อย</option>
						</select>
 					</div>
				</div>
			</div>
		...
		<div class="table-responsive">
			...
			<table class="table table-bordered table-striped table-hover">
				<thead class="info">
					<tr bgcolor="#dddddd">
						<th width="20px;">#</th>
						<th>ลักษณะของที่เกิดเหตุ</th>
						<th>อื่นๆ ระบุ ………............</th>
						<th>ที่พักอาศัย</th>
						<th>อื่นๆ ระบุ ………............</th>
						<th>สถานที่ทำงาน</th>
						<th>อื่นๆ ระบุ ………............</th>
						<th>สถานที่สาธารณะ</th>
						<th>ผู้พบเห็นเหตุการณ์</th>
						<th>ประชาชนทั่วไป</th>
						<th>บุคลากรทางการแพทย์</th>
						<th>อื่นๆ ระบุ ………............</th>
						<th>สาเหตุเบื้องต้นของภาวะหัวใจหยุดเต้น</th>
							...
							<div class="btn-group pull-right">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-event_information_id = "{encrypt_event_information_id}" data-row-number="{record_number}">
...
<label class="col-sm-3 text-right badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
					...
					<input type="hidden" name="encrypt_event_information_id" />
