<!--  [ View File name : edit_view.php ] -->
	<div class="card">
		<div class="card-header bg-primary">
			<h3 class="card-title"><i class="fa fa-edit"></i> แก้ไขข้อมูลแผนภาพผลการประเมิน</h3>
		</div>
		<div class="card-body">
			<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
				...
				<div class='form-group'>
					...
					<div class='col-sm-10'>
						...
						<input type="text" class="form-control " id="ca_resuscitation_name" name="ca_resuscitation_name" value="{record_ca_resuscitation_name}"  />
					</div>
				</div>
				<div class='form-group'>
					...
					<div class='col-sm-10'>
						...
						<textarea  class="form-control" id="ca_resuscitation_detail" name="ca_resuscitation_detail" rows="5">{record_ca_resuscitation_detail}</textarea>
					</div>
				</div>
				<div class='form-group'>
				...
				<div class='form-group'>
					...
					<div class='col-sm-10'>
						...
						<div class="upload-box">
						 ...
						 {preview_img}
						<input type="hidden" id="img_old_path" name="img_old_path" value="{record_img}" />
						<div style="clear:both"></div>
					</div>
				</div>
				<div class='form-group'>
				...
				<input type="hidden" name="encrypt_ca_resuscitation_id" value="{encrypt_ca_resuscitation_id}" />
