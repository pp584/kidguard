...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> แผนภาพผลการประเมิน</h3>
	</div>
	<div class="card-body">
		<div class="row">
			<div class="col-sm-12 col-md-12 mb-3">
				<div class="text-right">
					<a href="{page_url}/add" class="btn btn-success btn-lg" data-toggle="tooltip" title="เพิ่มข้อมูลใหม่">
						<i class="fa fa-plus-square"></i></span> เพิ่มแผนภาพผลการประเมิน
					</a>
		</div>
		</div>
			<div class="col-sm-12 col-md-9">
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<option value="ca_resuscitation_id">ca_resuscitation_id</option>
						</select>
 					</div>
					<div class="form-group">
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="ca_resuscitation_id|asc">ca_resuscitation_id น้อย - มาก</option><option value="ca_resuscitation_id|desc">ca_resuscitation_id มาก - น้อย</option>
						</select>
 					</div>
				</div>
			</div>
			...
			<table class="table table-bordered table-striped table-hover">
				...
				<tbody>
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td>{ca_resuscitation_name}</td>
						<td>{ca_resuscitation_detail}</td>
						<td>{preview_image}</td>
						<td>{preview_img}</td>
						<td>
							<div class=" text-center  ">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-ca_resuscitation_id = "{encrypt_ca_resuscitation_id}" data-row-number="{record_number}">
...
<label class="col-sm-3 text-right badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
					...
					<input type="hidden" name="encrypt_ca_resuscitation_id" />
