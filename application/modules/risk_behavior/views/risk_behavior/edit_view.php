<!--  [ View File name : edit_view.php ] -->
	<div class="card">
		<div class="card-header bg-primary">
			<h3 class="card-title"><i class="fa fa-edit"></i> แก้ไขข้อมูล <strong>risk_behavior</strong></h3>
		</div>
		<div class="card-body">
			<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
				...
				<div class='form-group'>
					<label class='col-sm-2 control-label' for='risk_behavior_id'>id  :</label>
					<div class='col-sm-10'>

						<input type="text" class="form-control " id="risk_behavior_id" name="risk_behavior_id" value="{record_risk_behavior_id}" readonly="readonly" />
					</div>
				</div>
				<div class='form-group'>
...
<label class="form-check-label" for="question234">จริง</label>
				...
				<input type="hidden" name="encrypt_risk_behavior_id" value="{encrypt_risk_behavior_id}" />
