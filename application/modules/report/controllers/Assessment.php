 ...
 */
class Assessment extends MEMBER_Controller
{
	...
	public function __construct()
	{
		...
		$this->num_links = 6;
		$this->uri_segment = 4;
		$this->load->model('report/Assessment_model', 'Assessment');
		$this->Assessment->session_name = 'report_assessment';

		$this->data['page_url'] = site_url('report/assessment');
		...
		$js_url = 'assets/js_modules/report/assessment.js?ft='. filemtime('assets/js_modules/report/assessment.js');
