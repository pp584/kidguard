...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i>ส่งออกข้อมุลการทำแบบประเมิน</h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<table class="table table-bordered table-striped table-hover">
				<thead class="info">
					<tr bgcolor="#dddddd">
						...
						<th>เพศ</th>
						<th>อายุ(ปี)</th>
						<th>สถานภาพการศึกษา(1.ศึกษาอยู่,2=ไม่ได้ศึกษา )</th>
						<th>เคยถูกให้ลองเสพสารเสพติดหรือไม่</th>
				...
				<tbody>
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td>{assessment_code}</td>
						<td>{province_name}</td>
						<td>{Sex}</td>
						<td>{Age}</td>
						<td>{Edu1}</td>
						<td>{try_data_yes_no}</td>
					</tr>
				</tbody>
			</table>
