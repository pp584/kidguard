...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title">
			...
			<span id="table-title">ออกรายงาน (คะแนนเฉลี่ย)</span>
		</h3>
	</div>
	<div class="card-body">
			...
			<table class="table table-bordered table-striped table-hover text-nowrap">
				<thead class="info">
					<tr style="background-color: #dddddd">
						...
						<?php foreach ($data_header as $header) : $tableColumnCount++; ?>
							<td class="text-center"><b><?= $header['graph_bar_name']; ?></b></td>
						<?php endforeach; ?>
					</tr>
				</thead>
				<tbody>
						...
						<?php foreach ($data_table as $data) : $itemIndex++ ?>
							<tr>
								...
								<?php foreach ($data['answers'] as $answer) : ?>
									<td class="text-center"><?= $answer['average_score'] ?></td>
								<?php endforeach; ?>
							</tr>
						<?php endforeach; ?>
					<?php else : ?>
