...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>cms_contact_us</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="cms_contact_us_id|asc">cms_contact_us_id น้อย - มาก</option><option value="cms_contact_us_id|desc">cms_contact_us_id มาก - น้อย</option>
						</select>
 					</div>
				</div>
			</div>
							...
							<div class="btn-group pull-right">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-cms_contact_us_id = "{encrypt_cms_contact_us_id}" data-row-number="{record_number}">
