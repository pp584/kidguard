...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i>จัดการข้อมูล<b>หน่วยบริการ</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
				...
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<div class="form-group">
						<select class="form-control" name="search_field" class="span2">
							<option value="service_unit_name">หน่วยบริการ</option>
						</select>
					</div>
					<div class="form-group">
				...
				<div class="pull-right text-right">
					<div class="form-group">
						<select class="form-control" id="set_order_by" class="span2" value="{order_by}">
							...
							<option value="service_unit_name|asc">หน่วยบริการ ก - ฮ</option>
							<option value="service_unit_name|desc">หน่วยบริการ ฮ - ก</option>
						</select>
					</div>
				</div>
			</div> -->
							...
							<div class="text-center">
								...
								<!-- <a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-service_unit_name = "{encrypt_service_unit_name}" data-row-number="{record_number}">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="formDelete">
					...
					<input type="hidden" name="encrypt_service_unit_name" />
