<!-- [ View File name : add_view.php ] -->
	<div class="card">
		<div class="card-header bg-primary">
			<h3 class="card-title"><i class="fa fa-plus-square"></i> เพิ่มข้อมูล <strong>Service_unit_name</strong></h3>
		</div>
		<div class="card-body">
			<form class="form-horizontal" id="formAdd" accept-charset="utf-8">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<input type="text" class="form-control " id="service_unit_name" name="service_unit_name" value=""  />
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="sequence">ลำดับ  :</label>
					<div class="col-sm-10">
				...
				<input type="hidden" 
														name="encrypt_service_unit_name" 
														value="{encrypt_service_unit_name}" />
			</form>
		</div> <!--panel-body-->
	</div> <!--panel-->
</div> <!--contrainer-->
