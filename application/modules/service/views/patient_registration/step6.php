...
<div class="padding-bottom-3x mb-1">
	<div class="card mb-12">
		<div class="p-4 text-center text-white text-lg bg-dark rounded-top"><span class="text-uppercase">6. การรักษาโดยทีมปฏิบัติการ</span><span class="text-medium"></span>
				...
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="card h-100">
						<div class="card-body">
							...
							<div class="row gutters">
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
									<h6 class="mb-2 text-primary">6.1 การบันทึกเวลา ROSC (การกลับมามีสัญญาณชีพ) ครั้งแรกเมื่อทีมปฏิบัติการแพทย์ฉุกเฉินไปถึง</h6>
								</div>
									...
									<div class="form-group">
										<table width="100%" border="0">
											<tr>
												...
												<td><input type="radio" name="imgsel" value="" checked="checked" /> ไม่ทราบเวลา </td>
											</tr>
										</table>
									</div>
								</div>
							...
							<div class="row gutters">
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
									<h6 class="mb-2 text-primary">6.2 การทำ CPR ของทีมปฏิบัติการแพทย์ฉุกเฉิน</h6>
								</div>
							...
							<div class="row gutters">
								<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
									<h6 class="mb-2 text-primary">6.3 เวลาที่เริ่ม CPR ณ จุดเกิดเหตุ (น.)</h6>
								</div>
								...
								<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
									<div class="form-group">
										<table width="100%" border="0">
											<tr>
												<td><input type="text" name="imgsel" value="" /></td>
											</tr>
										</table>
									</div>
								</div>
							...
							<div class="row gutters">
								<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
									<h6 class="mb-2 text-primary">6.4 เวลาที่สิ้นสุดการ CPR ณ จุดเกิดเหตุ (น.)</h6>
								</div>
							...
							<div class="row gutters">
								<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
									<h6 class="mb-2 text-primary">6.5 การมี ROSC (การกลับมามีสัญญาณชีพ)</h6>
								</div>
								...
								<div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-12">
									<div class="form-group">
										<input type="radio" name="imgsel" value="" checked="checked" />หลังจาก CPR โดยผู้พบเห็นเหตุการณ์<br />
										<input type="radio" name="imgsel" value="" checked="checked" />หลังจาก CPR โดยทีมปฏิบัติการแพทย์ฉุกเฉิน<br />
										<input type="radio" name="imgsel" value="" checked="checked" />หลังจากใช้ AED โดยผู้พบเห็นเหตุการณ์<br />
										<input type="radio" name="imgsel" value="" checked="checked" />หลังจากใช้ AED โดยทีมปฏิบัติการแพทย์ฉุกเฉิน<br />
										<input type="radio" name="imgsel" value="" checked="checked" />หลังจากทีมปฏิบัติการแพทย์ฉุกเฉินทำ Advanced cardiac life support (การช่วยฟื้นคืนชีพระดับสูง)<br />
