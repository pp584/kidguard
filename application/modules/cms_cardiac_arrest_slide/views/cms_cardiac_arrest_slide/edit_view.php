<!--  [ View File name : edit_view.php ] -->
	<div class="card">
		<div class="card-header bg-primary">
			<h3 class="card-title"><i class="fa fa-edit"></i> แก้ไขข้อมูล <strong>cms_cardiac_arrest_slide</strong></h3>
		</div>
		<div class="card-body">
			<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
				...
				<div class='form-group'>
					<label class='col-sm-2 control-label' for='cms_cardiac_arrest_id'>cms_cardiac_arrest_id  :</label>
					<div class='col-sm-10'>

						<input type="text" class="form-control " id="cms_cardiac_arrest_id" name="cms_cardiac_arrest_id" value="{record_cms_cardiac_arrest_id}" readonly="readonly" />
					</div>
				</div>
				<div class='form-group'>
				...
				<input type="hidden" name="encrypt_cms_cardiac_arrest_id" value="{encrypt_cms_cardiac_arrest_id}" />
