...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i>  จัดการ Slide สื่อความรู้ </h3>
	</div>
	<div class="card-body">
		<div class="row">
			<div class="col-sm-12 col-md-12 mb-3">
				<div class="text-right">
					<a href="{page_url}/add" class="btn btn-success btn-lg" data-toggle="tooltip" title="เพิ่มข้อมูลใหม่">
						<i class="fa fa-plus-square"></i></span> เพิ่ม Slide สื่อความรู้ใหม่
					</a>
				</div>
			</div>
					...
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td class="text-center">
							<div class="btn-group ">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm" data-toggle="tooltip" title="ลบรายการนี้" data-cms_cardiac_arrest_id="{encrypt_cms_cardiac_arrest_id}" data-row-number="{record_number}">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="formDelete">
					...
					<input type="hidden" name="encrypt_cms_cardiac_arrest_id" />
