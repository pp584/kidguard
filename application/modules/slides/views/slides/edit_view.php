<!--  [ View File name : edit_view.php ] -->
	<div class="card">
		<div class="card-header bg-primary">
			<h3 class="card-title"><i class="fa fa-edit"></i> แก้ไขข้อมูล Slider</h3>
		</div>
		<div class="card-body">
			<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
				...
				<div class='form-group'>
					<label class='col-sm-2 control-label' for='cms_slide_id'>ID  :</label>
					<div class='col-sm-10'>

						<input type="text" class="form-control " id="cms_slide_id" name="cms_slide_id" value="{record_cms_slide_id}" readonly="readonly" />
					</div>
				</div>
				<div class='form-group'>
				...
				<div class='form-group'>
					<label class='col-sm-2 control-label' for='sequences'>ลำดับ  :</label>
					<div class='col-sm-10'>

						<input type="text" class="form-control " id="sequences" name="sequences" value="{record_sequences}"  />
					</div>
				</div>
				<div class='form-group'>
				...
				<input type="hidden" name="encrypt_cms_slide_id" value="{encrypt_cms_slide_id}" />
