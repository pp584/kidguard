...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-images"></i> จัดการ Slider</h3>
	</div>
	<div class="card-body">
		<div class="row">
		...
		<div class="table-responsive">
			...
			<table class="table table-bordered table-striped table-hover">
				<thead class="info">
					<tr bgcolor="#dddddd">
						<!-- <th width="20px;">#</th> -->
						<th width="120px; text-align:center;">รูปภาพ</th>
						<th>เรื่อง</th>
				...
				<tbody>
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td><img style="height: 120px;width: 120px;" src="{base_url}{image}" ></td>
						<td>{title}</td>
						<td>{sequences}</td>
						<td>
							<div class="btn-group">
								...
								<a href="{site_url}website/slides/edit/{url_encrypt_id}" target="_blank" class="my-tooltip btn btn-warning btn-sm" data-toggle="tooltip" title="แก้ไขข้อมูล">
