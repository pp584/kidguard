...
class Employee_model extends MY_Model
{
	...
	{
		$emp_id = checkEncryptData($data['emp_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.emp_id = $emp_id");
	...
	{
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.emp_id = $id");
	...
	public function create($post)
	{
		...
		$data = array(
				...
				,'rf_company' => $post['rf_company']
				,'rf_pre_id' => $post['rf_pre_id']
				,'emp_name' => $post['emp_name']
				,'emp_surname' => $post['emp_surname']
				,'birthday' => setDateToStandard($post['birthday'])
				,'start_date' => setDateToStandard($post['start_date'])
				,'quit_date' => setDateToStandard($post['quit_date'])
				,'year_experience' => $post['year_experience']
		);
		$this->set_table_name($this->my_table);
	...
	*/
	...
	public function update($post)
	{
		...
		$emp_id = checkEncryptData($post['encrypt_emp_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.emp_id = $emp_id");
