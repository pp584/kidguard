...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>tb_room</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<table class="table table-bordered table-striped table-hover">
				<thead class="info">
					<tr bgcolor="#dddddd">
						...
						<th>id</th>
						<th>ชื่อห้องเรียน</th>
						<th>ครูประจำชั้น Ref Teacher Id Prefix Name</th>
						<th>ครูประจำชั้น Ref Teacher Id Firstname</th>
						<th>ครูประจำชั้น Ref Teacher Id Lastname</th>
