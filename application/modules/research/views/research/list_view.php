...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-file"></i> จัดการข้อมูลงานวิจัย</h3>
	</div>
	<div class="card-body">
		<div class="row">
			<div class="col-sm-12 col-md-12 mb-3">
				<div class="text-right">
					<a href="{page_url}/add" class="btn btn-success btn-lg" data-toggle="tooltip" title="เพิ่มข้อมูลใหม่">
						<i class="fa fa-plus-square"></i></span> เพิ่มข้อมูลงานวิจัยใหม่
					</a>
				</div>
			</div>
			<div class="col-sm-12 col-md-9">
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<a href="{page_url}" class="btn btn-info">--ค้นหา--</a>
					<div class="form-group">
						<select class="form-control" name="search_field" class="span2">
							<option value="cms_researchs_id">--เลือก--</option>
				...
				<div class="pull-right text-right">
					<div class="form-group">
						<select class="form-control" id="set_order_by" class="span2" value="{order_by}">
							...
							<option value="cms_researchs_id|asc">cms_researchs_id น้อย - มาก</option>
							<option value="cms_researchs_id|desc">cms_researchs_id มาก - น้อย</option>
							<option value="subject|asc">เรื่อง ก - ฮ</option>
							<option value="subject|desc">เรื่อง ฮ - ก</option>
						</select>
					</div>
				</div>
			</div>
					...
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td>
							<div class="btn-group pull-right">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm" data-toggle="tooltip" title="ลบรายการนี้" data-cms_researchs_id="{encrypt_cms_researchs_id}" data-row-number="{record_number}">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="formDelete">
					...
					<input type="hidden" name="encrypt_cms_researchs_id" />
