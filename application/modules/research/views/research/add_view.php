<!-- [ View File name : add_view.php ] -->
	<div class="card">
		<div class="card-header bg-primary">
			<h3 class="card-title"><i class="fa fa-plus-square"></i> เพิ่มข้อมูล <strong>Research</strong></h3>
		</div>
		<div class="card-body">
			<form class="form-horizontal" id="formAdd" accept-charset="utf-8">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<textarea  class="form-control ck_text_editor" id="detail" name="detail" rows="5"></textarea>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<textarea  class="form-control" id="research_name" name="research_name" rows="5"></textarea>
					</div>
				</div>
				<div class="form-group">
