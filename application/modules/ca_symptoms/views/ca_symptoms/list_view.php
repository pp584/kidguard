...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> จัดการข้อมูลที่ควรรู้ </h3>
	</div>
	<div class="card-body">
		<div class="row">
			<div class="col-sm-12 col-md-12 mb-3">
				<div class="text-right">
					<a href="{page_url}/add" class="btn btn-success btn-lg" data-toggle="tooltip" title="เพิ่มข้อมูลใหม่">
						<i class="fa fa-plus-square"></i></span> เพิ่มข้อมูลที่ควรรู้ใหม่
					</a>
				</div>
			</div>
				...
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<div class="form-group">
						<select class="form-control" name="search_field" class="span2">
							<option value="ca_symptoms_id">ca_symptoms_id</option>
						</select>
					</div>
					<div class="form-group">
				...
				<div class="pull-right text-right">
					<div class="form-group">
						<select class="form-control" id="set_order_by" class="span2" value="{order_by}">
							...
							<option value="ca_symptoms_id|asc">ca_symptoms_id น้อย - มาก</option>
							<option value="ca_symptoms_id|desc">ca_symptoms_id มาก - น้อย</option>
						</select>
					</div>
				</div>
			</div> -->
					...
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td class="text-center">
							<div class="btn-group ">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm" data-toggle="tooltip" title="ลบรายการนี้" data-ca_symptoms_id="{encrypt_ca_symptoms_id}" data-row-number="{record_number}">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="formDelete">
					...
					<input type="hidden" name="encrypt_ca_symptoms_id" />
