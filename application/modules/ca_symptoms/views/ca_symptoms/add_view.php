...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-plus-square"></i> เพิ่มข้อมูลที่ควรรู้ <strong></strong></h3>
	</div>
	<div class="card-body">
		<form class="form-horizontal" id="formAdd" accept-charset="utf-8">
			{csrf_protection_field}
			<div class="form-group">
				<label class="col-sm-2 control-label" for="ca_symptoms_name">ชื่อ :</label>
				<div class="col-sm-10">

					<input type="text" class="form-control " id="ca_symptoms_name" name="ca_symptoms_name" value="" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<input type="text" class="form-control " id="ca_symptoms_detail" name="ca_symptoms_detail" value="" />
				</div>
			</div>
			<div class="form-group">
