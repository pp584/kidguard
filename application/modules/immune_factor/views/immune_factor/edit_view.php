<!--  [ View File name : edit_view.php ] -->
	<div class="card">
		<div class="card-header bg-primary">
			<h3 class="card-title"><i class="fa fa-edit"></i> แก้ไขข้อมูล <strong>immune_factor</strong></h3>
		</div>
		<div class="card-body">
...
<input  type="radio"
									...
									value="1" class="form-check-input"
									autocomplete="off" data-record-value="{record_question48}" />
...
<label class="form-check-label" for="question484">เป็นประจำ</label>
				...
				<input type="hidden" name="encrypt_immune_factor_id" value="{encrypt_immune_factor_id}" />
