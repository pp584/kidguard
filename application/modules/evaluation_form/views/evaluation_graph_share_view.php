...
<div class="container-main p-2 mt-2" style="    padding-bottom: 30px !important; overflow-y:auto">
	...
	<div class="container-content w-full h-full flex flex-column justify-between" style="max-height: 700px;">
		<div>
			<div class="ml-10 mr-10 mt-20 ml-2 mr-2">
				<div class="ml-0 mt-3">
					<div class="text-center flex recommence-content-2 shadow-3">
						<div class="flex">
		...
		border-radius: 5px;">
								...
								<input type="hidden" id="fetchGraph" data-type="id" value="<?php echo $_GET['id']; ?>">
							</div>
