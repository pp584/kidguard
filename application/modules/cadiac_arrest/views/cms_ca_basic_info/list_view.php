...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-file"></i> จัดการข้อมูลพื้นฐาน </h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="ca_basic_info|asc">ca_basic_info น้อย - มาก</option><option value="ca_basic_info|desc">ca_basic_info มาก - น้อย</option>
						</select>
 					</div>
				</div>
			</div>
