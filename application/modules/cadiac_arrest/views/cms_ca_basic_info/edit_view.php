<!--  [ View File name : edit_view.php ] -->
	<div class="card">
		<div class="card-header bg-primary">
			<h3 class="card-title"><i class="fa fa-edit"></i> แก้ไขข้อมูล <strong>cms_ca_basic_info</strong></h3>
		</div>
		<div class="card-body">
			<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
				...
				<div class='form-group'>
					<label class='col-sm-2 control-label' for='ca_basic_info'>ca_basic_info  :</label>
					<div class='col-sm-10'>

						<input type="text" class="form-control " id="ca_basic_info" name="ca_basic_info" value="{record_ca_basic_info}" readonly="readonly" />
					</div>
				</div>
				<div class='form-group'>
