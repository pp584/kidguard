 ...
 */
class Assessment1_edit extends CRUD_Controller
{
	...
	public function __construct()
	{
		...
		$this->data['page_url'] = site_url('assessment/assessment1_edit');

		$this->data['page_title'] = 'ONCB';

		$js_url = 'assets/js_modules/assessment/assessment1_edit.js?ft=' . filemtime('assets/js_modules/assessment/assessment1_edit.js');
	...
	protected function render_view($path)
	{
		...
		$this->parser->parse('template/front-end/assessment_edit_view', $this->data);
	}
