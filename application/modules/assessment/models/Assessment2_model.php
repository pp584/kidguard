 ...
 * @date 2023-07-23
 */
class Assessment2_model extends MY_Model
{
	...
	{
		$data = array(
			'province_id' => $post['province_id'], 'question_1' => $post['question_1'], 'question_2' => $post['question_2'], 'question_3' => $post['question_3'], 'question_4' => $post['question_4'], 'question_5' => $post['question_5'], 'question_6' => $post['question_6'], 'question_7' => $post['question_7'], 'question_8' => $post['question_8'], 'question_9' => $post['question_9'], 'question_10' => $post['question_10'], 'question_11' => $post['question_11'], 'question_12' => $post['question_12'], 'question_13' => $post['question_13'], 'question_14' => $post['question_14']
		);
