			...
			<div class="form-group">
				...
				<div class="">
					...
					<div class="form-check form-check-inline">
						<input type="radio" name="question_1" id="question_11" value="1" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="question_11">ชาย</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="question_1" id="question_12" value="2" class="form-check-input" autocomplete="off" />
