...
class DashboardOverview extends MEMBER_Controller
{
	...
	public function search()
	{
		...
		$this->data['selectYears'] = $this->getYearForSelectOption();
	...
	public function QuestionAVG($group_type_id, $select, $section)
	{
		...
		// and data_year = '$education_year' 
		// and group_type_id = $group_type_id ")->row();

		// if($assessment1_1_query_result->$select){
		// 	return $assessment1_1_query_result->$select;
		// }else{
		// 	return 0;
		// }
