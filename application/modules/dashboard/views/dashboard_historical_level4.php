            ...
            <div class="justify-content-center">
                ...
                <div class="card-body">
                    ...
                    <script>
                        ...
                        const data2 = {
                            labels: <?=$self_management_g1_label?>,
                            datasets: [
                        ...
                        const options2 = {
                            ...
                            plugins: {
                                title: {
                                    display: true,
                                    text: 'ผลประเมินย้อนหลัง 3 ปี เมื่อเทียบกับเกณฑ์มาตรฐานปัจจัยภูมิคุ้มกัน'
                                },
                                legend: {
                                    position: 'right',
                                    labels: {
                    ...
                    <script>
                        ...
                        const options4 = {
                            ...
                            plugins: {
                                title: {
                                    display: true,
                                    text: 'ผลประเมินย้อนหลัง 3 ปี เมื่อเทียบกับเกณฑ์มาตรฐานปัจจัยบวก'
                                },
                                legend: {
                                    position: 'right',
                                    labels: {
