...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตรวจสอบความถูกต้อง</h3>
	</div>
	<div class="card-body">
		<div class="row">
				...
				<div class="pull-right text-right">
					<div class="form-group">
						<select class="form-control" id="set_order_by" class="span2" value="{order_by}">
							...
							<option value="province|asc">จังหวัด น้อย - มาก</option>
							<option value="province|desc">จังหวัด มาก - น้อย</option>
						</select>
					</div>
				</div>
			</div>
					...
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td>
							<div class="btn-group pull-right">
								...
								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm" data-toggle="tooltip" title="ลบรายการนี้" data-basic_information_id="{encrypt_basic_information_id}" data-row-number="{record_number}">
