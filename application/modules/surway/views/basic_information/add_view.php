		...
		<form class="form-horizontal" id="formAdd" accept-charset="utf-8">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="form-check form-check-inline">
						<input type="radio" name="edu1" id="edu11" value="1" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="edu11">ศึกษาอยู่</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="edu1" id="edu12" value="2" class="form-check-input" autocomplete="off" />
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="form-check form-check-inline">
						<input type="radio" name="edu_id" id="edu_id1" value="1" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="edu_id1">ม1</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="edu_id" id="edu_id2" value="2" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="edu_id2">ม2</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="edu_id" id="edu_id3" value="3" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="edu_id3">ม3</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="edu_id" id="edu_id4" value="4" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="edu_id4">ม4</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="edu_id" id="edu_id5" value="5" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="edu_id5">ม5</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="edu_id" id="edu_id6" value="6" class="form-check-input" autocomplete="off" />
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="form-check form-check-inline">
						<input type="radio" name="sisbro" id="sisbro1" value="1" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="sisbro1">เป็นลูกคนเดียว</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="sisbro" id="sisbro2" value="2" class="form-check-input" autocomplete="off" />
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="form-check form-check-inline">
						<input type="radio" name="family_status" id="family_status1" value="1" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="family_status1">บิดามารดาอยู่ด้วยกัน</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="family_status" id="family_status2" value="2" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="family_status2">บิดามารดาแยกกันอยู่</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="family_status" id="family_status3" value="3" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="family_status3">บิดาเสียชีวิตแล้ว</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="family_status" id="family_status4" value="4" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="family_status4">มารดาเสียชีวิตแล้ว</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="family_status" id="family_status5" value="5" class="form-check-input" autocomplete="off" />
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="form-check form-check-inline">
						<input type="radio" name="dad_job" id="dad_job1" value="1" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="dad_job1">เกษตร</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="dad_job" id="dad_job2" value="2" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="dad_job2">รับราชการ</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="dad_job" id="dad_job3" value="3" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="dad_job3">พนักงานเอกชน</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="dad_job" id="dad_job4" value="4" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="dad_job4">รัฐวิสาหกิจ</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="dad_job" id="dad_job5" value="5" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="dad_job5">รับจ้างทั่วไป</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="dad_job" id="dad_job6" value="6" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="dad_job6">ธุรกิจส่วนตัว</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="dad_job" id="dad_job7" value="7" class="form-check-input" autocomplete="off" />
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="form-check form-check-inline">
						<input type="radio" name="mom_job" id="mom_job1" value="1" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="mom_job1">เกษตร</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="mom_job" id="mom_job2" value="2" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="mom_job2">รับราชการ</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="mom_job" id="mom_job3" value="3" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="mom_job3">พนักงานเอกชน</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="mom_job" id="mom_job4" value="4" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="mom_job4">รัฐวิสาหกิจ</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="mom_job" id="mom_job5" value="5" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="mom_job5">รับจ้างทั่วไป</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="mom_job" id="mom_job6" value="6" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="mom_job6">ธุรกิจส่วนตัว</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="mom_job" id="mom_job7" value="7" class="form-check-input" autocomplete="off" />
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="form-check form-check-inline">
						<input type="radio" name="family_earn" id="family_earn1" value="1" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="family_earn1">ต่ำกว่า15000บาท</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="family_earn" id="family_earn2" value="2" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="family_earn2">15000-30000</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="family_earn" id="family_earn3" value="3" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="family_earn3">30001-40000</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="family_earn" id="family_earn4" value="4" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="family_earn4">40001-50000</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="family_earn" id="family_earn5" value="5" class="form-check-input" autocomplete="off" />
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="form-check form-check-inline">
						<input type="checkbox" name="consult[]" id="consult1" value="1" class="form-check-input" />
						<label for="consult1" class="form-check-label">บิดา</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="consult[]" id="consult2" value="2" class="form-check-input" />
						<label for="consult2" class="form-check-label">มารดา</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="consult[]" id="consult3" value="3" class="form-check-input" />
						<label for="consult3" class="form-check-label">ญาติ</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="consult[]" id="consult4" value="4" class="form-check-input" />
						<label for="consult4" class="form-check-label">เพื่อน</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="consult[]" id="consult5" value="5" class="form-check-input" />
						<label for="consult5" class="form-check-label">ครู</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="consult[]" id="consult6" value="6" class="form-check-input" />
						<label for="consult6" class="form-check-label">คนรัก</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="consult[]" id="consult7" value="7" class="form-check-input" />
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="form-check form-check-inline">
						<input type="radio" name="try_drugs" id="try_drugs1" value="1" class="form-check-input" autocomplete="off" />
						<label class="form-check-label" for="try_drugs1">เคย</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="radio" name="try_drugs" id="try_drugs2" value="2" class="form-check-input" autocomplete="off" />
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="form-check form-check-inline">
						<input type="checkbox" name="type_drugs[]" id="type_drugs1" value="1" class="form-check-input" />
						<label for="type_drugs1" class="form-check-label">ยาบ้า</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="type_drugs[]" id="type_drugs2" value="2" class="form-check-input" />
						<label for="type_drugs2" class="form-check-label">ยาอี</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="type_drugs[]" id="type_drugs3" value="3" class="form-check-input" />
						<label for="type_drugs3" class="form-check-label">ยาเค</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="type_drugs[]" id="type_drugs4" value="4" class="form-check-input" />
						<label for="type_drugs4" class="form-check-label">ฝิ่น</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="type_drugs[]" id="type_drugs5" value="5" class="form-check-input" />
						<label for="type_drugs5" class="form-check-label">เฮโรอีน</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="type_drugs[]" id="type_drugs6" value="6" class="form-check-input" />
						<label for="type_drugs6" class="form-check-label">กัญชา</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="type_drugs[]" id="type_drugs7" value="7" class="form-check-input" />
						<label for="type_drugs7" class="form-check-label">ใบกระท่อม</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="type_drugs[]" id="type_drugs8" value="8" class="form-check-input" />
						<label for="type_drugs8" class="form-check-label">ทินเนอร์</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="type_drugs[]" id="type_drugs9" value="9" class="form-check-input" />
						<label for="type_drugs9" class="form-check-label">ยาไอซ์</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="type_drugs[]" id="type_drugs10" value="10" class="form-check-input" />
						<label for="type_drugs10" class="form-check-label">บุหรี่</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="type_drugs[]" id="type_drugs11" value="11" class="form-check-input" />
						<label for="type_drugs11" class="form-check-label">สุรา</label>
					</div>
					<div class="form-check form-check-inline">
						<input type="checkbox" name="type_drugs[]" id="type_drugs12" value="12" class="form-check-input" />
