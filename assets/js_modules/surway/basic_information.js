...
var BasicInformation = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('surway/basic_information/preview/'+ id),
	...
	saveFormData: function(){
		var frm_action = site_url('surway/basic_information/save');
		...
		if(loading_on(obj) == true){
			...
			$.ajax({
				...
				success: function (results) {
					...
					if(results.is_successful){
						window.location = site_url('surway/basic_information');
					}
				},
				error : function(jqXHR, exception){
					ajaxErrorMessage(jqXHR, exception);
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('surway/basic_information/update');
	...
	deleteRecord: function(){
		var frm_action = site_url('surway/basic_information/del');
	...
	readExcel: function(){
		var frm_action = site_url('surway/basic_information/read_excel');
	...
	saveExcel: function(){
		var frm_action = site_url('surway/basic_information/save_excel_data');
		...
		if(loading_on(obj) == true){
			...
			$.ajax({
				...
				success: function (results) {
					...
					if(results.is_successful){
						alert_type = 'success';
						goto_page('surway/basic_information');
					}else{
						alert_type = 'danger';
					}
					notify('บันทึกข้อมูล', results.message, alert_type, 'center');
