...
var PatientProfile = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('reports/patient_profile/preview/'+ id),
	...
	saveFormData: function(){
		var frm_action = site_url('reports/patient_profile/save');
		...
		if(loading_on(obj) == true){
			...
			$.ajax({
				...
				success: function (results) {
					...
					if(results.is_successful){
						window.location = site_url('reports/patient_profile');
					}
				},
				error : function(jqXHR, exception){
					ajaxErrorMessage(jqXHR, exception);
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('reports/patient_profile/update');
	...
	deleteRecord: function(){
		var frm_action = site_url('reports/patient_profile/del');
