...
var PatientProfile = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('services/patient_profile/preview/'+ id),
	...
	saveFormData: function(){
		var frm_action = site_url('services/patient_profile/save');
		...
		if(loading_on(obj) == true){
			...
			$.ajax({
				...
				success: function (results) {
					...
					if(results.is_successful){
						setTimeout(function(){
							$(window.location).attr('href', site_url("services/patient_profile"));
						}, 500);
					}
				},
				error : function(jqXHR, exception){
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('services/patient_profile/update');
	...
	deleteRecord: function(){
		var frm_action = site_url('services/patient_profile/del');
