...
var Assessment1 = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('assessment/assessment1/preview/'+ id),
	...
	saveFormData: function(){
		var frm_action = site_url('assessment/assessment1/save');
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('assessment/assessment1/update');
	...
	deleteRecord: function(){
		var frm_action = site_url('assessment/assessment1/del');
		...
		$.ajax({
			...
			success: function (results) {
				if(results.is_successful){
					alert_type = 'success';
					setTimeout(function(){
						$(window.location).attr('href', site_url(Assessment1.current_path));
					}, 500);
				}else{
					alert_type = 'danger';
				}
...
$(document).ready(function() {
	...
	$('#btnSave').click(function() {
		$('#addModal').modal('hide');
		Assessment1.saveFormData();
		return false;
	});//click

	$('#btnSaveEdit').click(function() {
		return Assessment1.validateFormEdit();
	});//click
	...
	if(typeof param_current_page != 'undefined'){
		Assessment1.current_page = Math.abs(param_current_page);
	}

	if(typeof param_current_path != 'undefined'){
		Assessment1.current_path = param_current_path;
	}
	...
	$(document).on('click','.btn-delete-row', function(){
		...
		Assessment1.confirmDelete(pId,  row_num);
	});//click

	$(document).on('click','#btn_confirm_delete', function(){
		Assessment1.deleteRecord();
	});
