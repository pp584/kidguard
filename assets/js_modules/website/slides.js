...
var Slides = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('website/slides/preview/'+ id),
	...
	saveFormData: function(){
		var frm_action = site_url('website/slides/save');
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('website/slides/update');
	...
	confirmDelete: function (pCmsSlideId,  irow){
		$('[name="encrypt_cms_slide_id"]').val(pCmsSlideId);
	...
	deleteRecord: function(){
		var frm_action = site_url('website/slides/del');
		...
		$.ajax({
			...
			success: function (results) {
				if(results.is_successful){
					alert_type = 'success';
					setTimeout(function(){
						$(window.location).attr('href', site_url(Slides.current_path));
					}, 500);
				}else{
					alert_type = 'danger';
				}
...
$(document).ready(function() {
	...
	$('#btnSaveEdit').click(function() {
		return Slides.validateFormEdit();
	});//click
	...
	if(typeof param_current_page != 'undefined'){
		Slides.current_page = Math.abs(param_current_page);
	}

	if(typeof param_current_path != 'undefined'){
		Slides.current_path = param_current_path;
	}
	...
	$(document).on('click','.btn-delete-row', function(){
		...
		var pCmsSlideId = $(this).attr('data-cms_slide_id');

		Slides.confirmDelete(pCmsSlideId,  row_num);
	});//click
