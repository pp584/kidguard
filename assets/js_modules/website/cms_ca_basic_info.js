...
var CmsCaBasicInfo = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('website/cms_ca_basic_info/preview/'+ id),
	...
	saveFormData: function(){
		var frm_action = site_url('website/cms_ca_basic_info/save');
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('website/cms_ca_basic_info/update');
	...
	deleteRecord: function(){
		var frm_action = site_url('website/cms_ca_basic_info/del');
