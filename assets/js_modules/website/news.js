...
var News = {
	...
	loadPreview: function (id) {
		$.ajax({
			method: 'GET',
			url: site_url('website/news/preview/' + id),
	...
	saveFormData: function () {
		var frm_action = site_url('website/news/save');
	...
	saveEditForm: function () {
		...
		var frm_action = site_url('website/news/update');
	...
	deleteRecord: function () {
		var frm_action = site_url('website/news/del');
...
$(document).ready(function () {
	...
	setDropdownList('#category_id');
	setDropdownList('#userid');
	setDropdownList('#status');
	$('#userid').select2("readonly", true);
