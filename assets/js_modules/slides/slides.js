...
var Slides = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('slides/slides/preview/'+ id),
	...
	saveFormData: function(){
		var frm_action = site_url('slides/slides/save');
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('slides/slides/update');
	...
	deleteRecord: function(){
		var frm_action = site_url('slides/slides/del');
